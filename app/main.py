...
from app.api.routes import administracion, alumnos, app_version, asistencias, audit_logs, auth, estados_membresia, health, maestros, membresias, reglamentos, reportes, roles, tipos_membresia, transacciones, users
...
app.include_router(administracion.router, prefix=settings.API_V1_PREFIX)
