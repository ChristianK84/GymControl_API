...
class TipoMembresia(Base):
    ...
    limite_dias_semana: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    ...
    costo_dia_extra_sabado: Mapped[Optional[Decimal]] = mapped_column(Numeric(10, 2), nullable=True)
